...
namespace MaxWellGPUDrivenRenderPipeline
{
    ...
    public unsafe static class UnsafeUtility
    {
        ...
        {
            long align = size % 16;
            return (T*)Unity.Collections.LowLevel.Unsafe.UnsafeUtility.Malloc(size, align == 0 ? 16 : (int)align, allocator);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void* Malloc(long size, Allocator allocator)
        {
            long align = size % 16;
            return Unity.Collections.LowLevel.Unsafe.UnsafeUtility.Malloc(size, align == 0 ? 16 : (int)align, allocator);
        }
